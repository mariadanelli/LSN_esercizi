...
double Random :: Rannfunz (FunzioneBase &f) { 
	double x=f.Eval (Rannyu());         //valuto nell'inversa della cumulativa per ottenere variabile distribuita secondo una distribuzione
	return x;}
